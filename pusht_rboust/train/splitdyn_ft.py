...
from pusht_rboust.shared.models import MLP, JEPA, MLPDynamicsPredictor, SIGReg


DEFAULT_DATASET_PATH = "pusht_rboust/data/pusht_expert_train_preproc.h5"
DEFAULT_INIT_RUN_DIR = "pusht_rboust/models/mlpdyn"
DEFAULT_RUN_DIR = "pusht_rboust/models/splitdyn_ft"
FIXED_FRAMESKIP = 1
