...
from pusht_rboust.shared.models import JEPA, MLP, MLPDynamicsPredictor, SIGReg


DEFAULT_DATASET_PATHS = [
    Path("pusht_rboust/data/pusht_diffusion_train.h5"),
    Path("pusht_rboust/data/pusht_diffusion_edge.h5"),
    # Path("pusht_rboust/data/pusht_diffusion_random.h5"),
]
DEFAULT_INIT_RUN_DIR = "pusht_rboust/models/mlpdyn_embd_48"
DEFAULT_RUN_DIR = "pusht_rboust/models/mlpdyn_embd_48_straighten"
FIXED_FRAMESKIP = 1
