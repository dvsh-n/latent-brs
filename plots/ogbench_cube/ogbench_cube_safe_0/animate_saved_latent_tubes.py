...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--current-color", type=str, default=FIGURE_BLUE)
    parser.add_argument("--current-line-color", type=str, default=FIGURE_BLUE)
