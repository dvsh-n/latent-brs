...
def collect_trajectory(
    *,
    ...
    frames = [render_rgb_frame(renderer, env, camera_id)]
    ...
    for step_idx in range(max_episode_steps):
        ...
        frames.append(render_rgb_frame(renderer, env, camera_id))
...
def main() -> None:
    ...
    with mujoco.Renderer(env.model, height=args.height, width=args.width) as renderer:
        ...
        sample_frame = render_rgb_frame(renderer, env, camera_id)
