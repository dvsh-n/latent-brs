#!/usr/bin/env python3
"""Train latent-safety/PyHJ avoid-DDPG on the rope latent safety env."""
...
from rope.safety.latent_env import RopeLatentSafetyEnv, load_latent_safety_components  # noqa: E402

DEFAULT_CACHE_PATH = "rope/safety/cache/rope_latent_safety_classifier_train_noshadow_tanh.pt"
DEFAULT_RUN_ROOT = "rope/safety/runs"
