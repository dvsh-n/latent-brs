#!/usr/bin/env python3
"""Evaluate a trained rope PyHJ policy/value function against cached margins."""
...
from rope.safety.latent_env import RopeLatentSafetyEnv, load_latent_safety_components

from PyHJ.data import Batch  # noqa: E402

DEFAULT_CACHE_PATH = "rope/safety/cache/rope_latent_safety_classifier_train_noshadow_tanh.pt"
DEFAULT_POLICY_PATH = "rope/safety/runs/pyhj_train_noshadow_tanh/policy_latest.pth"
DEFAULT_CLASSIFIER_CHECKPOINT = "rope/safety/obs_net/da270d7d1050f110/model.pt"
