#!/usr/bin/env python3
"""Build a rope Latent Policy Barrier prototype bank."""
...
from rope.safety.constraints import DEFAULT_OBSTACLE_DATA_PATH
from rope.safety.latent_cache import (
    compute_margins,
    encode_h5_pixels,
    make_episode_index,
    make_markov_states,
...
DEFAULT_OUTPUT_PATH = "rope/safety/runs/lpb_rope/lpb_bank.pt"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--margin-source", choices=("none", "analytic", "classifier"), default="analytic")
...
def main() -> None:
    ...
    if int(args.frame_batch_size) < 1:
    ...
    prototypes, prototype_indices = choose_prototypes(whitened.cpu(), count=int(args.num_prototypes), seed=int(args.seed))
