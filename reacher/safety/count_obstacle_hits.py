#!/usr/bin/env python3
"""Count reacher HDF5 frames/trajectories classified as entering the obstacle zone."""
...
from reacher.safety.obstacle_classifier import (
    ObstacleMLP,
...
DEFAULT_DATASET = REPO_ROOT / "reacher/data/test_data_50hz/reacher_test.h5"
DEFAULT_OBSTACLE_MODEL = REPO_ROOT / "reacher/Haoran_obs_data/obs_net_sm_model/8acfaa546b7cc1b6/model.pt"
DEFAULT_MODEL_DIR = REPO_ROOT / "reacher/Haoran_obs_data/mlpdyn_ft_6"
