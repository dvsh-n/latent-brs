#!/usr/bin/env python3
"""Evaluate a trained reacher PyHJ policy/value function against cached margins."""
...
DEFAULT_POLICY_PATH = "reacher/safety/runs/pyhj_train_tanh/policy_latest.pth"
...
def main() -> None:
    ...
    probe_env = ReacherLatentSafetyEnv(
        dynamics=components.dynamics,
        cache=components.cache,
        oracle=components.oracle,
        device=components.device,
