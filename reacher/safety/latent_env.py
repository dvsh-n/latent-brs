"""Latent safety env for reacher PyHJ training and smoke checks."""
...
from reacher.safety.classifier_oracle import ReacherObstacleClassifierMargin
...
class ReacherLatentSafetyEnv(gym.Env[np.ndarray, np.ndarray]):
...
def load_latent_safety_components(
    *,
    ...
    if oracle_kind == "knn":
        ...
        oracle = ReacherObstacleClassifierMargin(
...
ReacherLatentSafetySmokeEnv = ReacherLatentSafetyEnv
