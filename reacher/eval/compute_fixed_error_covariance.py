#!/usr/bin/env python3
"""Compute a calibrated constant error covariance from the first half of Reacher error data."""
...
DEFAULT_DATA_PATH = "reacher/eval/reacher_one_step_error_data.pt"
DEFAULT_OUT_FILE = "reacher/eval/fixed_error_covariance.pt"
