#!/usr/bin/env python3
"""Train the non-Markov history-2 MLP dynamics ablation for Reacher."""
...
DEFAULT_RUN_DIR = "reacher/models/mlpdyn_train_history2"
FINETUNE_DIR = None
FIXED_FRAMESKIP = 1
...
def parse_args() -> argparse.Namespace:
    ...
    args.non_markov_state_dim = args.embed_dim
    return args
