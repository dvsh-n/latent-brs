#!/usr/bin/env python3
"""Train the single-step Markov-state MLP dynamics ablation for Reacher."""
...
DEFAULT_RUN_DIR = "reacher/models/mlpdyn_train_markov_singlestep"
FINETUNE_DIR = None
FIXED_FRAMESKIP = 1
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--num-preds", type=int, default=1, help="Single-step prediction horizon.")
