...
DEFAULT_INIT_RUN_DIR = "ogbench/models/mlpdyn_embd_24"
DEFAULT_RUN_DIR = "ogbench/models/mlpdyn_embd_12"
FIXED_FRAMESKIP = 1


def register_legacy_checkpoint_aliases() -> None:
    """Resolve checkpoints pickled under the old ``ogbench_cube`` package."""

    import pusht.shared.models as shared_models
