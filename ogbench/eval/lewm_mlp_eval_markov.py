#!/usr/bin/env python3
"""Evaluate Markov-state MLP-predictor LE-WM latent rollouts on one OGBench trajectory."""
...
from ogbench.train.lewm_train_mlp_markov import DEFAULT_FRAMESKIP, LeWMOGBenchDataset

DEFAULT_DATASET_PATH = "ogbench/data/ogbench_cube_train.h5"
DEFAULT_MODEL_DIR = "ogbench/models/lewm_ogbench_mlpdyn_markov"
DEFAULT_OUT_DIR = "ogbench/eval/lewm_mlpdyn_markov_eval"
...
def plot_markov_states(
    ...
    *,
    ...
    for plot_idx, (start_dim, end_dim) in enumerate(splits, start=1):
        ...
        fig.suptitle(f"OGBench Markov MLP LE-WM rollout episode {episode_idx}, dims {start_dim}-{end_dim - 1}")
        fig.tight_layout()
