"""Latent safety env for ogbench PyHJ training and smoke checks."""
...
from ogbench.safety.classifier_oracle import OGBenchCubeObstacleClassifierMargin
...
class OGBenchCubeLatentSafetyEnv(gym.Env[np.ndarray, np.ndarray]):
...
def load_latent_safety_components(
    *,
    ...
    if oracle_kind == "knn":
        ...
        oracle = OGBenchCubeObstacleClassifierMargin(
...
OGBenchCubeLatentSafetySmokeEnv = OGBenchCubeLatentSafetyEnv
