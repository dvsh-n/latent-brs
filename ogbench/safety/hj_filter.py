"""Closed-loop latent HJ safety filter for ogbench experiments."""
...
from ogbench.safety.latent_env import load_latent_safety_components
...
class OGBenchCubeHJSafetyFilter:
    ...
    def __init__(
        ...
        *,
        ...
        self.history_len = ilqr_base.required_markov_history(self.markov_deriv)
