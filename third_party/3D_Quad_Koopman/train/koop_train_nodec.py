...
MODEL_SAVE_PATH = "models/koop_quad3d_nodec.pt"
LOG_DIR = "runs/koop_quad3d_nodec"
...
def train(args):
    ...
    print("Starting training for decoder-free Deep Koopman model (3D Quadrotor)")
    print_config(
        {
            **model_config,
...
if __name__ == "__main__":
    ...
    args = parse_train_args(
        defaults,
        description="Train decoder-free Deep Koopman model for 3D Quadrotor",
    )
    train(args)
