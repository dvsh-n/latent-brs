#!/usr/bin/env python3
"""Train and conformalize a PushT insertion latent obstacle classifier from collected obstacle data."""
...
DEFAULT_OUT_DIR = "pusht/plan/obs_net_insert"
...
def log_progress(message: str) -> None:
    print(f"[pusht_obstacle_net] {message}", flush=True)
...
def main() -> None:
    ...
    log_progress("Loading PushT world model and encoding train, validation, and calibration frames.")
