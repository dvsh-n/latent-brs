...
def main():
    ...
    controller = GenericMPC(
        ...
        SQPConfig(max_sqp_iterations=1, warm_start=False, feas_tol=5e-2, step_tol=1e-4, line_search=False),
    ...
    for step_idx in mpc_pbar:
        ...
        mpc_pbar.set_postfix(step_compute_time_s=f"{step_compute_time_s:.4f}")
